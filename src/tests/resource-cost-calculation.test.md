...
## Test Scenario 3: Cooked White Shark Cost Updates

**Steps:**
1. Open the app
2. Go to Market tab
3. Note Coal market price (default: 6 gold)
4. Note White shark market price (default: 56 gold)
5. Go to Resources tab
6. Find "Cooked White Shark"
7. Verify Cost = 62 gold (56 + 6)
8. Go back to Market tab
9. Change White shark market price to 70 gold
10. Go to Resources tab
11. Find "Cooked White Shark"
12. Verify Cost = 76 gold (70 + 6)

**Expected Result:**
Cost updates dynamically to 76 gold when White shark price changes to 70 (test PASSES)
...
5. **White shark** - No inputs (fishing rod cost?), cost = 25
6. **Cooked White Shark** - Inputs: 1x White shark + 1x Coal, cost = White shark market + Coal market
7. **Cooked White Shark full** - Inputs: 1x Coal (fishing included), cost = White shark cost + Coal market
8. **Cooked White Shark full + coal** - Inputs: None (coal mining included), cost = White shark cost
...
- [ ] Changing White shark price updates "Cooked White Shark" cost
